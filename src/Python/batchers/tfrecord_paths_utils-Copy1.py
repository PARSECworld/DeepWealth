...
DHS_TFRECORDS_PATH_ROOT = os.path.join('/home/abenabbes/data96/dhs_tfrecords2019')
...
def dhs_incountry(dataset: str, splits: Iterable[str]) -> dict[str, np.ndarray]:
    ...
    folds_pickle_path = os.path.join('/home/benabbes/Ali/data/dhs_incountry_folds2019.pkl')
