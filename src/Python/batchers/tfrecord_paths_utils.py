...
from batchers.dataset_constants96 import SIZES, SURVEY_NAMES
...
#DHS_TFRECORDS_PATH_ROOT = os.path.join('/home/abenabbes/africapoverty/dhsdata')
DHS_TFRECORDS_PATH_ROOT = os.path.join('/hdd/home/abenabbes/final_ex/DHS962019')
#DHS_TFRECORDS_PATH_ROOT = os.path.join('/home/abenabbes/Ali-a/data/dhs1')
...
def dhs_incountry(dataset: str, splits: Iterable[str]) -> dict[str, np.ndarray]:
    ...
    folds_pickle_path = os.path.join('/hdd/home/abenabbes/final_ex/dhs_incountry_co.pkl')
