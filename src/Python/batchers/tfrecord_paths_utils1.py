...
from batchers.dataset_constants96 import SIZES, SURVEY_NAMES, davidtest


ROOT_DIR = os.path.dirname(os.path.dirname(__file__))
DHS_TFRECORDS_PATH_ROOT = os.path.join(ROOT_DIR, '/hdd/home/abenabbes/final_ex/villages97/Australie')
...
#africa_poverty_clean/data/dhs_David
#madagascar_2000, madagascar_2005,madagascar_2010, madagascar_2015, madagascar_2019 
#tanzania_2000, tanzania_2005, tanzania_2010, tanzania_2015, tanzania_2019

def dhs() -> np.ndarray:
        #'''Gets a list of paths to TFRecords.
       ...
       # '''
        ...
        for i in range (0,5):
            print(davidtest[i])
            glob_path = os.path.join(DHS_TFRECORDS_PATH_ROOT, davidtest[i], '*.tfrecord.gz')           
...
#def dhs() -> np.ndarray:
        ...
        #glob_path = os.path.join(DHS_TFRECORDS_PATH_ROOT, 'madagascar_2015', '*.tfrecord.gz')
    ...
    #glob_path = os.path.join(DHS_TFRECORDS_PATH_ROOT, 'madagascar_2013' + '*', '*.tfrecord.gz')
        #print(glob_path)
        #tfrecord_paths = glob(glob_path)
