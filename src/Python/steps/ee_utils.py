...
def surveyyear_to_range(survey_year: int, nl: bool = False) -> tuple[str, str]:
    ...
    if  survey_year == 1996:
        start_date = '1996-1-1'
        end_date = '1997-12-31'
    elif  survey_year == 1998:
        start_date = '1997-1-1'
        end_date = '1999-12-31'
    elif  survey_year == 1999:
        start_date = '1998-1-1'
        end_date = '2000-12-31'
    elif  survey_year == 2000:
        start_date = '1999-1-1'
        end_date = '2001-12-31'
    elif  survey_year == 2001:
        start_date = '2000-1-1'
        end_date = '2002-12-31'
    elif  survey_year == 2002:
        start_date = '2001-1-1'
        end_date = '2003-12-31'
    elif  survey_year == 2003:
        start_date = '2002-1-1'
        end_date = '2004-12-31'
    elif  survey_year == 2004:
        start_date = '2003-1-1'
        end_date = '2005-12-31'
    elif  survey_year == 2005:
        start_date = '2004-1-1'
        end_date = '2006-12-31'
    elif  survey_year == 2006:
        start_date = '2005-1-1'
        end_date = '2007-12-31'
    elif  survey_year == 2007:
        start_date = '2006-1-1'
        end_date = '2008-12-31'
        if nl:
            end_date = '2010-12-31'  # artificially extend end date for DMSP
    elif  survey_year == 2008:
        start_date = '2007-1-1'
        end_date = '2009-12-31'
        if nl:
            end_date = '2010-12-31'  # artificially extend end date for DMSP
        ...
        start_date = '2009-1-1'
        end_date = '2010-12-31'
    elif  survey_year == 2011:
        start_date = '2010-1-1'
        end_date = '2011-12-31'
    elif  survey_year == 2012:
        start_date = '2011-1-1'
        end_date = '2014-12-31'
        ...
        start_date = '2013-1-1'
        end_date = '2015-12-31'
    elif  survey_year == 2015:
        start_date = '2014-1-1'
        end_date = '2016-12-31'
    elif  survey_year == 2016:
        start_date = '2015-1-1'
        end_date = '2017-12-31'
    elif  survey_year == 2017:
        start_date = '2016-1-1'
        end_date = '2018-12-31'
    elif  survey_year == 2018:
        start_date = '2017-1-1'
        end_date = '2019-12-31'
    elif  survey_year == 2019:
        start_date = '2018-1-1'
        end_date = '2020-12-31'
    elif  survey_year == 2020:
        start_date = '2019-1-1'
        end_date = '2021-12-31'
        ...
        raise ValueError(f'Invalid survey_year: {survey_year}. '
                         'Must be between 1996 and 2022 (inclusive)')
